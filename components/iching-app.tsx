...
export function IChingApp() {
  ...
  return <main className="site-shell">
    <header className="site-nav"><a className="brand-mark" href="#top" onClick={reset}><span className="brand-symbol">易</span><span>易の余白<small>THE SPACE OF CHANGE</small></span></a><nav><a href="#about">易経について</a><a href="#plans">プラン</a><a href="#api-key">AI設定</a><a href="/handwritten">手書き</a><a href="/login">3日間お試し</a><button onClick={()=>setPhase(phase === "hexagrams" ? "home" : "hexagrams")}>六十四卦 <ArrowUpRight size={13}/></button></nav></header>
