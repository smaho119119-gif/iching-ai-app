...
export function BillingPlans() {
  ...
  const plans=[
    {id:"standard" as const,name:"スタンダード",price:"980",description:"易を日々の思考習慣に。",features:["日々のコイン占い","変爻と之卦の読み解き","AIはご自身のAPIキーで利用"]},
    {id:"premium" as const,name:"プレミアム",price:"2,980",description:"古代の作法とAIを、さらに深く。",features:["スタンダードの全機能","手書き卦のVision認識","別途ご自身のAI APIキーが必要"]},
  ];

  return <section className="billing-section" id="plans"><div className="section-eyebrow"><span className="eyebrow-dot"/> SUBSCRIPTION · OPTIONAL</div><h2>問いを深める、<br/><span>ふたつのプラン。</span></h2><p className="billing-intro">基本の易経占いは無料です。AI解釈・手書き認識には別途ご自身のAI APIキーとプロバイダー利用料が必要です。手書き認識はプレミアム契約が有効な場合に利用できます。</p>
